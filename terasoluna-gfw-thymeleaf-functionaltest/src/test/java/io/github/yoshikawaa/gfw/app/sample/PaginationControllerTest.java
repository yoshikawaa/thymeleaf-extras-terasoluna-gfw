...
public class PaginationControllerTest extends WebClientTestSupport {
    ...
    public void testPagination() throws Exception {
        ...
        new PaginationMatcher(page, "//ul[@id='pagination-8']", "li").matches("disabled", "javascript:void(0)", "<<")
                .matches("disabled", "javascript:void(0)", "<")
                .matches("disabled", "javascript:void(0)", "1")
                .matches("active", contextPath + "/sample/pagination?page=1&size=20&item=sample", "2")
                .matches("active", contextPath + "/sample/pagination?page=2&size=20&item=sample", "3")
                .matches("active", contextPath + "/sample/pagination?page=3&size=20&item=sample", "4")
                .matches("active", contextPath + "/sample/pagination?page=4&size=20&item=sample", "5")
                .matches("active", contextPath + "/sample/pagination?page=5&size=20&item=sample", "6")
                .matches("active", contextPath + "/sample/pagination?page=6&size=20&item=sample", "7")
                .matches("active", contextPath + "/sample/pagination?page=7&size=20&item=sample", "8")
                .matches("active", contextPath + "/sample/pagination?page=8&size=20&item=sample", "9")
                .matches("active", contextPath + "/sample/pagination?page=9&size=20&item=sample", "10")
                .matches("active", contextPath + "/sample/pagination?page=1&size=20&item=sample", ">")
                .matches("active", contextPath + "/sample/pagination?page=49&size=20&item=sample", ">>")
                .end();

        new PaginationMatcher(page, "//ul[@id='pagination-9']", "li").matches("disabled", "javascript:void(0)", "<<")
                .matches("disabled", "javascript:void(0)", "<")
                .matches("disabled", "javascript:void(0)", "1")
                .matches("active", "?page=1&size=20", "2")
                .matches("active", "?page=2&size=20", "3")
