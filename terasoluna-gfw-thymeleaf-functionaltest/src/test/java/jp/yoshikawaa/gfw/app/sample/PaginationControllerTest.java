...
public class PaginationControllerTest extends WebClientConfigurator {
    ...
    public void testPagination() throws Exception {
        ...
        new PaginationMatcher(page, "//ul[@id='pagination-1']", "li").matches("disabled", "javascript:void(0)", "<<")
                .matches("disabled", "javascript:void(0)", "<").matches("disabled", "javascript:void(0)", "1")
                .matches("active", "?page=1&size=20", "2").matches("active", "?page=2&size=20", "3")
                .matches("active", "?page=3&size=20", "4").matches("active", "?page=4&size=20", "5")
                .matches("active", "?page=5&size=20", "6").matches("active", "?page=6&size=20", "7")
                .matches("active", "?page=7&size=20", "8").matches("active", "?page=8&size=20", "9")
                .matches("active", "?page=9&size=20", "10").matches("active", "?page=1&size=20", ">")
                .matches("active", "?page=49&size=20", ">>").end();

        new PaginationMatcher(page, "//ul[@id='pagination-2' and @class='pagination']", "li")
                .matches("disabled", "javascript:void(0)", "<<").matches("disabled", "javascript:void(0)", "<")
                .matches("disabled", "javascript:void(0)", "1").matches("active", "?page=1&size=20", "2")
                .matches("active", "?page=2&size=20", "3").matches("active", "?page=3&size=20", "4")
                .matches("active", "?page=4&size=20", "5").matches("active", "?page=5&size=20", "6")
                .matches("active", "?page=6&size=20", "7").matches("active", "?page=7&size=20", "8")
                .matches("active", "?page=8&size=20", "9").matches("active", "?page=9&size=20", "10")
                .matches("active", "?page=1&size=20", ">").matches("active", "?page=49&size=20", ">>").end();
        ...
        new PaginationMatcher(page, "//ul[@id='pagination-4']", "li").matches("d", "javascript:void(0)", "<<")
                .matches("d", "javascript:void(0)", "<").matches("d", "javascript:void(0)", "1")
                .matches("a", "?page=1&size=20", "2").matches("a", "?page=2&size=20", "3")
                .matches("a", "?page=3&size=20", "4").matches("a", "?page=4&size=20", "5")
                .matches("a", "?page=5&size=20", "6").matches("a", "?page=6&size=20", "7")
                .matches("a", "?page=7&size=20", "8").matches("a", "?page=8&size=20", "9")
                .matches("a", "?page=9&size=20", "10").matches("a", "?page=1&size=20", ">")
                .matches("a", "?page=49&size=20", ">>").end();

        new PaginationMatcher(page, "//ul[@id='pagination-5']", "li").matches("disabled", "javascript:void(0)", "first")
                .matches("disabled", "javascript:void(0)", "prev").matches("disabled", "javascript:void(0)", "1")
                .matches("active", "?page=1&size=20", "2").matches("active", "?page=2&size=20", "3")
                .matches("active", "?page=3&size=20", "4").matches("active", "?page=4&size=20", "5")
                .matches("active", "?page=5&size=20", "6").matches("active", "?page=6&size=20", "7")
                .matches("active", "?page=7&size=20", "8").matches("active", "?page=8&size=20", "9")
                .matches("active", "?page=9&size=20", "10").matches("active", "?page=1&size=20", "next")
                .matches("active", "?page=49&size=20", "last").end();

        new PaginationMatcher(page, "//ul[@id='pagination-6']", "li").matches("disabled", "javascript:void(0)", "<<")
                .matches("disabled", "javascript:void(0)", "<").matches("active", "?page=0&size=20", "1")
                .matches("active", "?page=1&size=20", "2").matches("active", "?page=2&size=20", "3")
                .matches("active", "?page=3&size=20", "4").matches("active", "?page=4&size=20", "5")
                .matches("active", "?page=1&size=20", ">").matches("active", "?page=49&size=20", ">>").end();
        ...
        new PaginationMatcher(page, "//ul[@id='pagination-7']", "li").matches("disabled", "javascript:void(0)", "<<")
                ...
                .matches("active", contextPath + "/sample/pagination/49?size=20", ">>").end();
